                ...
                <div class="container" id="siswa">
                    ...
                    <div class="row text-center justify-content-center">
                        ...
                        <div class="card-all col-md-4 col-xl-4 mb-5" data-aos="fade-up" data-aos-duration="1000">
                            <div class="card" style="width: 18rem;">
                                <img src="img/siswa/<?php echo $siswa['f_nama']; ?>.jpg" class="card-img-top"
                                    alt="Siswa">
                                <div class="card-body bg-dark">
                                    <h5 class="card-title text-white">
                                        <?php echo $siswa['f_nama']; ?>
                                    </h5>
                                    <span>Kelas: <?php echo $siswa['f_idkelas']; ?></span>
                                    <p>Jurusan: <?php echo $siswa['f_idjurusan']; ?></p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-8">
                    <table class="table">
                        ...
                        <tbody class="table-group-divider">
                            ...
                            <?php
                            $sql = "SELECT t_siswa.f_nama, t_kelas.f_nama AS f_kelas, t_jurusan.f_nama AS f_jurusan
                            FROM t_siswa
                            INNER JOIN t_kelas ON t_siswa.f_idkelas = t_kelas.f_idkelas
                            INNER JOIN t_jurusan ON t_siswa.f_idjurusan = t_jurusan.f_idjurusan";
                            $row = $db->getALL($sql);

                            // Initialize $i if it's not defined earlier.
                            $no = 1;
